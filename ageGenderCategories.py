...
import glob
from prompts import ageGenderPrompts
...
class AgeGenderCategories:
    ...
    def startProcess(self, images_path):
        ...
        list_of_age_prompts = ageGenderPrompts.age_prompts
        list_of_gender_prompts = ageGenderPrompts.gender_prompts
        faces_path = []
        detected_age_gender = []
        ...
        try:
            ...
            # Save the collage
            collage_path = "Results/collageAgeGender.jpg"
            collage.save(collage_path)
            collage.show()
            results.to_csv("Results/AgeGenderResult.csv")
        except Exception as e:
            print(e)
            raise
